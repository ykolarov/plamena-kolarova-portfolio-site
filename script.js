  ...
  bg: {
    ...
    about: {
      ...
      strengths: [
        ...
        "Прецизност и внимание към детайли",
        "Добър усет към типография, цвят и композиция",
        "Адаптивност към различни формати и платформи",
      ],
    ...
    services: {
      ...
      cards: [
        ...
        },
        {
          ...
          text: "Инфографики, иконки и визуални материали за кампании.",
        },
      ],
    },
    work: {
      ...
      fields: {
        ...
        logos: {
          ...
          titleBottom: "Дизайн",
          description:
            "Лога с ясна разпознаваемост и адаптивност за дигитални и печатни формати.",
        ...
        "print-design": {
          ...
          titleBottom: "Дизайн",
          description:
            "Печатни материали с изчистена визия и прецизно оформление.",
        ...
        "3d-design": {
          ...
          titleBottom: "Дизайн",
          description:
            "3D модели, създадени по време на обучението ми в университета.",
    ...
    barecareCaseStudy: {
      ...
      info: [
        ...
        {
          title: "Подход",
          text: "Изчистена визуална йерархия, хармонична цветова палитра, фокус върху продукта, четима типография и балансирани композиции във всички видове съдържание и кампании.",
        },
      ],
      stats: [
